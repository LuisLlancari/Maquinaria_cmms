...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2024 a las 11:37:51
...
(1, 'ARADO1', 0, 'AR-0001', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 1, 2, 0, 400),
(2, 'ARADO2', 0, 'AR-0002', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 1, 3, 0, 400),
(3, 'AZUFRADORA1', 0, 'AZ-0001', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 2, 2, 0, 100),
(4, 'AZUFRADORA2', 0, 'AZ-0002', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 2, 3, 0, 100),
(5, 'CHASKI1', 0, 'CH-0001', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 3, 2, 0, 200),
(6, 'CHASKI2', 0, 'CH-0002', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 3, 3, 0, 200),
(7, 'JACTO1', 0, 'JA-0001', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 4, 2, 0, 300),
(8, 'JACTO2', 0, 'JA-0002', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 4, 3, 0, 300),
(9, 'ROTATIVA1', 0, 'RO-0001', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 5, 2, 0, 500),
(10, 'ROTATIVA2', 0, 'RO-0002', 1, 1, '0000-00-00 00:00:00.000000', '0000-00-00', 1, 5, 3, 0, 500);
...
(2, 'VIÑATERO2', 100, 0, 1, 1, 1, 1, 2),
(3, 'DOBLE1', 100, 0, 1, 1, 2, 2, 1),
(4, 'DOBLE2', 100, 0, 1, 1, 2, 2, 2),
(5, 'RETEN1', 100, 0, 1, 1, 3, 3, 1),
(6, 'RETE2', 100, 0, 1, 1, 3, 3, 2),
(7, 'SIMPLE1', 100, 0, 1, 1, 4, 4, 1),
...
(1, 'pbkdf2_sha256$600000$lsPKerPOPfJhEdtGtbiTed$wrCjMhBF/pJU9CbZE48gx1lAYwKO3Go2hSm5j/yg+qs=', '2024-06-20 07:21:25.000000', 1, 'admin', 'Harold', 'Quispe', '', 1, 1, '2024-06-20 07:17:36.000000', 2),
(2, 'pbkdf2_sha256$600000$3TsemhkH23gV3KmkYuiQmq$KDSutxQ6TsV/T0oKY3U8UMUTCwTikpdT1NImqI9Df6g=', NULL, 0, 'carlos', 'carlos', 'chuquispuma', '', 0, 1, '2024-06-20 08:38:24.312502', 3),
(3, 'pbkdf2_sha256$600000$cK03nUxZBnC5p42752ZS6A$J4GHO6It2wkcdcKGzCt99JJwOSSj02Vmdh18sE15LY4=', '2024-06-20 08:51:29.540047', 0, 'mario', 'MARIO', 'GUZMAN', '', 0, 1, '2024-06-20 08:39:10.742169', 3);
...
--
ALTER TABLE `mantenimiento_detmotivos`
  MODIFY `iddetmotivo` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mantenimiento_programacionmantenimiento`
  MODIFY `idprogramacionmantenimiento` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mantenimiento_recambios`
--
ALTER TABLE `mantenimiento_recambios`
  MODIFY `idrecambio` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `programacion_labor_detallelabor`
  MODIFY `iddetlabor` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `programacion_labor_tipolabor`
  MODIFY `idtipolabor` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tractor_reportetractor`
--
ALTER TABLE `tractor_reportetractor`
  MODIFY `idreportetractor` int(11) NOT NULL AUTO_INCREMENT;

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuracion_implemento', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to='componente_pieza.configuraciontipoimplemento', verbose_name='Configuracion')),
            ],
            options={

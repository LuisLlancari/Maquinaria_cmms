    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True, verbose_name='Estado')),
                ('idsede', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='localizacion.sede', verbose_name='Sede')),
            ],
            options={
                'verbose_name': 'Base',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True, verbose_name='Estado')),
                ('idbase', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='localizacion.base')),
            ],
        ),
    ]

...
class BaseForm(forms.ModelForm):
    idsede_id = forms.ModelChoiceField(queryset=Sede.objects.all(), empty_label=None, widget=forms.Select(attrs={'class': 'form-control'}))
...
class AreaForm(forms.ModelForm):
    Base = forms.ModelChoiceField(queryset=Base.objects.all(), empty_label=None, widget=forms.Select(attrs={'class': 'form-control'}))

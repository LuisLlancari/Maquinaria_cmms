...
class Mantenimiento(models.Model):
  ...
  tipomantenimiento = models.CharField(max_length=45, choices= MANTENIMIENTO_CHOICES, null=True, blank=True, verbose_name="Tipo mantenimiento")
